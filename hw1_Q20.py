...
########################################################################
# Modify your PLA in Question 18 to run for 100 updates instead of 50, 
# and verify the performance of wpocket using the test set. Please repeat 
# your experiment for 2000 times, each with a different random seed. What
# is the average error rate on the test set?
##########################################################################
