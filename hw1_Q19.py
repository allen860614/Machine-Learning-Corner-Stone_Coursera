...
########################################################################
# Modify your PLA in Question 18 to return the PLA vector after 50 updates
# instead of the pocket after 50 updates. Run the modified on D, and verify
# the performance of wpocket using the test set. Please repeat your 
# experiment for 2000 times, each with a different random seed. What is the
# average error rate on the test set?
##########################################################################
